   //Write a C program to find the maximum n-m such that array[n]>array[m] from a given array[].
  // Given array arr[], maximum j-i such that arr[j]>arr[i]...
   ...
   Enter the 10 elements: 7 5 8 2 3 2 4 1 0 2
   The Given array is: 7 5 8 2 3 2 4 1 0 2 
   ...
   m=7, n=9, arr[m]=1, arr[n]=2: Difference=2

   m=8, n=9, arr[m]=0, arr[n]=2: Difference=1
